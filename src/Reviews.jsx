                                ...
                                <Card key={review.id} style={{ marginBottom: '30px', padding: '20px', marginLeft: '40px', marginRight: '40px', borderRadius: '15px', height: '100%' }}>
                                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        <div>
                                            {
                                                (review.stars==1)?
                                                    <img src={star1} style={{ marginRight: '20px', width: '175px', marginTop: '0px' }} alt="stars" />
                                                :(review.stars==2)?
                                                    <img src={star2} style={{ marginRight: '20px', width: '175px', marginTop: '0px' }} alt="stars" />
                                                :(review.stars==3)?
                                                    <img src={star3} style={{ marginRight: '20px', width: '175px', marginTop: '0px' }} alt="stars" />
                                                :(review.stars==4)?
                                                    <img src={star4} style={{ marginRight: '20px', width: '175px', marginTop: '0px' }} alt="stars" />
                                                :<img src={star5} style={{ marginRight: '20px', width: '175px', marginTop: '0px' }} alt="stars" />
                                            }
